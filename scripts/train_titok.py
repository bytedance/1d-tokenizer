...
Example Command:
WANDB_MODE=offline WORKSPACE=/opt/tiger/1d_tokenization accelerate launch --num_machines=1 --num_processes=8 --machine_rank=0 --main_process_ip=127.0.0.1 --main_process_port=9999 --same_network scripts/train_titok.py config=configs/stage1/titok_b64.yaml \
...
WANDB_MODE=offline WORKSPACE=/opt/tiger/1d_tokenization accelerate launch --num_machines=1 --num_processes=8 --machine_rank=0 --main_process_ip=127.0.0.1 --main_process_port=9999 --same_network scripts/train_titok.py config=configs/stage2/titok_b64.yaml \
